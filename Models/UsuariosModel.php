...
class UsuariosModel extends Query{
    private $usuario, $nombre, $clave, $id, $estado,$estadoC,$userCrea,$permisos;
    ...
    public function registrarUsuario($usuario, $nombre, $clave, $userCrea, $permisos= array(),$estadoC=1)
    {
